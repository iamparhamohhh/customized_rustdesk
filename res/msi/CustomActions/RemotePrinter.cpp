...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_PRINTER_PORT = L"rahbardesk Printer";
    LPCWCH RD_PRINTER_NAME = L"rahbardesk Printer";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through rahbardesk Printer.

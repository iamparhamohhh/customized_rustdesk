...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("About RustDesk", ""),
        ("About Rahbar Desk", "About Rahbar Desk"),
        ("About Rahbar Team", "About Rahbar Team"),
        ("rahbar_team_description", "Rahbar Team is a dedicated group of software engineers committed to building secure, high-performance remote desktop solutions. Our mission is to empower businesses and individuals with reliable, easy-to-use tools for seamless remote access and collaboration — without compromising on privacy or security."),
        ("app_brand_name", "Rahbar Desk"),
        ("app_team_name", "Rahbar Team"),

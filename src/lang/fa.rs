...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("About Rahbar Desk", "درباره رهبر دسک"),
        ("About Rahbar Team", "درباره تیم رهبر"),
        ("rahbar_team_description", "تیم رهبر متشکل از گروهی از مهندسان نرم‌افزار متعهد به ساخت راه‌حل‌های امن و با کارایی بالا برای دسکتاپ از راه دور است. مأموریت ما توانمندسازی کسب‌وکارها و افراد با ابزارهای قابل اعتماد و آسان برای دسترسی و همکاری از راه دور — بدون هیچ‌گونه سازش در حریم خصوصی و امنیت."),

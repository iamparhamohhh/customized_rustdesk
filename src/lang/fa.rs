...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("About Rahbar Desk", "درباره راهبر دسک"),
        ("About Rahbar Team", "درباره تیم راهبر"),
        ("rahbar_team_description", "تیم راهبر متشکل از گروهی از مهندسان نرم\u200cافزار متعهد به ساخت راه\u200cحل\u200cهای امن و با کارایی بالا برای دسکتاپ از راه دور است. مأموریت ما توانمندسازی کسب\u200cوکارها و افراد با ابزارهای قابل اعتماد و آسان برای دسترسی و همکاری از راه دور — بدون هیچ\u200cگونه سازش در حریم خصوصی و امنیت."),
        ("app_brand_name", "راهبر دسک"),
        ("app_team_name", "تیم راهبر"),
